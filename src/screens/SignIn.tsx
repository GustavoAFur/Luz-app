        ...
        <View style={{
          ...
          <View style={{
            ...
            <View style={{
              ...
              <MaskInput
                ...
                onChangeText={(mask, unmasked) => setCpf(unmasked)}
                value={cpf}
                onFocus={() => {
          ...
          <Pressable
            onPress={async () => {
              ...
              if (cpf != '' && password != '') {
                auth()
                  .signInWithEmailAndPassword(`${cpf}@eilumina.com`, password)
                  .then(() => {
        ...
        <View style={{
          ...
          <Pressable
            ...
            <Text style={{
              ...
              Não tem uma conta?  <Text style={{ fontFamily: 'GeneralSans-Semibold', color: '#0077FF' }}>
                Criar conta
              </Text>
            </Text>
          </Pressable>
